 ...
 *
 * The starter deck stays text-only so it remains visually neutral. Imported
 * decks exercise the complete local-media rendering path separately.
 */
...
export const LEGACY_HOLA_IMAGE: SpanishBasicsFixtureImage = {
  name: "hola.png",
...
export const SPANISH_BASICS_FIXTURE_VERSION = 3;
