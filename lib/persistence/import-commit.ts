...
export function buildImportGraphRecords(
  ...
  const cards = input.graph.cards.map((card): CardRecord => {
    ...
    return {
      ...
      frontText: card.content.frontText,
      backText: card.content.backText,
      answerText: card.content.answerText,
      css: card.content.css,
      frontHtml: card.content.frontHtml,
      backHtml: card.content.backHtml,
      answerHtml: card.content.answerHtml,
      backIncludesFront: card.content.backIncludesFront,
